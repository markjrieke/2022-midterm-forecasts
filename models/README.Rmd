...
* Updated poll model to scale loess span relative to days out from election:
  * `last_poll` > 100 days -> `span = 1`
  * `last_poll` <= 100 days -> `span = 0.25 * (last_poll/100) + 0.75`
...
![Poll model output with interaction](diagnostics/training/poll_model_interactions.png)
